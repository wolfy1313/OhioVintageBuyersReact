...
const ContactForm = () => {
  return (
    <div>
      <div>
        <form className='w-full max-w-sm' method="POST" action="https://formspree.io/f/mjvddkno" encType="multipart/form-data">
          ...
          <label>Details about your items:
            <textarea name="message" placeholder="Details of your items"></textarea>
          </label>
          <label>Include any pertinent images here
